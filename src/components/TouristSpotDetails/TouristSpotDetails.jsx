...
const TouristSpotDetails = () => {
  ...
  return (
    <section className="container grid grid-cols-1 lg:grid-cols-12 gap-6">
      <div className="border border-primary-extraLight lg:col-span-8 rounded overflow-hidden">
        <figure className="relative">
          ...
          <span className="bg-primary-main text-white px-3 py-1.5 font-semibold absolute bottom-4 rounded left-4 capitalize">
            {country_name}
          </span>
        </figure>
        <div className="p-6">
          <div>
            ...
            <p className="flex items-center gap-2 mt-5">
              ...
              <span className="font-medium capitalize">{travel_time} days</span>
            </p>
            ...
            <p className="max-w-xl mt-4">
              <span className="text-lg font-semibold mr-1.5">Description:</span>
              {short_description}
            </p>
          </div>
        </div>
