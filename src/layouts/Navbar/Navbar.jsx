      ...
      <nav className="container flex items-center justify-between">
        ...
        <ul className="flex items-center gap-7">
          <li>
            <NavLink
              className={({ isActive }) =>
                isActive ? "font-bold text-primary-main"  : "text-lg font-medium relative before:w-0 before:h-0.5 before:bg-primary-main before:absolute before:-bottom-1 before:rounded hover:before:w-full before:transition-all before:duration-300"
              }
              to="/"
            >
              Home
